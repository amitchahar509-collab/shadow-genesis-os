...
export const ALL_AGENTS = ["CEO", "RESEARCH", "ARCHITECT", "ENGINEERING", "DESIGN", "GROWTH", "QUALITY", "DEPLOYMENT", "SECURITY", "OPPORTUNITY", "REVENUE", "INTERNET", "VENTURE", "CUSTOMER", "ACQUISITION"];
...
const GRAPH: Record<string, { to: string; types: MessageType[] }[]> = {
  ...
  ACQUISITION: [{ to: "GROWTH", types: ["FINDINGS"] }, { to: "CEO", types: ["FINDINGS"] }, { to: "CUSTOMER", types: ["DELEGATE"] }],
};
