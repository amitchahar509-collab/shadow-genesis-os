...
- **Demand graph, arena/feedback/marketplace/benchmark engines, dashboard UI** (V8 G1, G3, G6–G13) — not present. Dashboard UI (G13, "no hidden systems") and Benchmark Arena (G12) are the ranked-highest next steps.
