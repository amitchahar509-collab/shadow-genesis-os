...
- **Digital customer simulation, demand graph, acquisition loop, long-horizon operator, competition/reality engines** (directive V6 Phases 2–5; V5 Phases 8, 9) — not present. Customer Simulation (V6 Phase 2) is now the ranked-highest missing layer.
