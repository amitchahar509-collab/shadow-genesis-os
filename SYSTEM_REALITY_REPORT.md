...
- **Demand graph, arena/feedback/marketplace/benchmark engines** (V8 G1, G3, G6–G12) — not present. Benchmark Arena (G12) and Reality Feedback (G9) are the ranked-highest next steps.
