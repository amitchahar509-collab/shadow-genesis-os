...
- **Demand graph, acquisition loop, arena/feedback/marketplace/benchmark engines, dashboard UI** (V8 G1, G3–G4, G6–G13) — not present. Acquisition loop (G4) is the ranked-highest next step (the operate phase watches but doesn't yet grow), then dashboard UI (G13).
