...
- **Demand graph, acquisition loop, long-horizon operator, approval queue, competition/reality engines** (directive V7 Phases 3–9, 11–13) — not present. Auto-wiring the reality chain into the CEO plan (V7 backlog V2) is the ranked-highest next step toward the "create a company" completion condition.
