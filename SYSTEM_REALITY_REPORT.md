...
- **Demand graph, reality feedback, arena/marketplace engines** (V8 G1, G3, G6–G9, G11) — not present. Reality Feedback (G9) and SaaS/auth (G10) are the ranked-highest next steps.
