...
- **Demand graph, arena/marketplace/scanner engines** (V8 G1, G3, G6–G8, G11) — not present. SaaS/auth (G10, top production blocker) and World Scanner upgrade (G1) are the ranked-highest next steps.
